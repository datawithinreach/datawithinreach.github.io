...
import { formatDate, getURL, getImgURL, renderNews, renderCourses, writeAddress } from './common.js';
...
Promise.all([
    ...
    renderCourses(value[2], courseContainer);
    // console.log('people', value[4]);
    renderPeople(value[3], peopleContainer);
});
